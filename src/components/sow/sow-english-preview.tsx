      ...
      <div className="flex items-start justify-between gap-4 border-b border-app-border pb-4">
        ...
        {onToggleExpand && (
          <button
            ...
            className="grid size-8 shrink-0 place-items-center rounded-control border border-app-border bg-app-surface-subtle text-app-muted transition-colors hover:bg-app-border hover:text-brand-600 no-print"
          >
            {isExpanded ? (
