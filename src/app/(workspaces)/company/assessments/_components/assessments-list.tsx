              ...
              >
                <div className="space-y-3 flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-6 text-xs text-app-muted border-t border-app-border/60 pt-3">
                    ...
                    <div>
                      모집 마감일: <strong className="text-app-foreground font-bold font-mono ml-1">{formatDate(project.recruitmentEndAt)}</strong>
                    </div>
                    <div>
                      예산: <strong className="text-app-foreground font-medium ml-1">{formatBudget(project)}</strong>
                    </div>
                  </div>
                </div>
