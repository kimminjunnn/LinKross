...
export default function TalentAssessmentDetailPage() {
  ...
  const assessment: TalentAssessment | null = assessmentId
  ...
  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/freelancer/applications/${assessmentId}`
      : `https://linkross.app/freelancer/applications/${assessmentId}`;
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 pb-16">
      ...
      <div className="flex items-center gap-2 text-xs text-app-muted">
        <Link href="/company/assessments" className="hover:text-app-foreground transition-colors">
          인재 역량검증
        </Link>
