...
import { getCompanyProfileSettings, getCompanySubscription } from "@/lib/backend";

import { CompanyProfileForm } from "./profile-form";
import { SubscriptionForm } from "./subscription-form";

export default async function SettingsPage() {
  const [result, subscriptionResult] = await Promise.all([getCompanyProfileSettings(), getCompanySubscription()]);
  return (
    <div className="mx-auto w-full max-w-4xl">
      ...
      {subscriptionResult.ok ? <SubscriptionForm initialSubscription={subscriptionResult.data} /> : null}
