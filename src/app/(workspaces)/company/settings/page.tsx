...
import { getCompanyProfileSettings, getCompanySubscriptionOverview } from "@/lib/backend";

import { CompanyProfileForm } from "./profile-form";
import { SubscriptionForm } from "./subscription-form";

export default async function SettingsPage() {
  const [result, subscriptionResult] = await Promise.all([getCompanyProfileSettings(), getCompanySubscriptionOverview()]);
  return (
    <div className="mx-auto w-full max-w-4xl">
      ...
      {subscriptionResult.ok ? <SubscriptionForm overview={subscriptionResult.data} /> : null}
