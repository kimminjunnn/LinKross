...
export default async function ProjectDetailLayout({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      <nav aria-label="현재 위치" className="no-print flex items-center gap-1 text-xs text-app-muted">
      ...
      <div className="no-print mt-3 flex flex-wrap items-center gap-3">
        <h1 className="text-3xl font-bold tracking-tight text-app-foreground sm:text-4xl">
          {project.title}
        </h1>
        <StatusBadge tone={tone}>{status}</StatusBadge>
      </div>

      <div className="no-print mt-7 rounded-card border border-app-border bg-app-surface px-3 sm:px-5">
