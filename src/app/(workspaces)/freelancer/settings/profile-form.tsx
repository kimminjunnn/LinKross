    ...
    <form action={(formData) => startTransition(async () => {
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm font-bold text-app-foreground sm:col-span-2">
          ...
          <input name="walletAddress" defaultValue={initialProfile.walletAddress ?? ""} placeholder="0x..." pattern="^0x[0-9a-fA-F]{40}$" className="mt-2 min-h-11 w-full rounded-control border border-app-border-strong px-3 text-sm font-normal font-mono" />
        </label>
      </div>
