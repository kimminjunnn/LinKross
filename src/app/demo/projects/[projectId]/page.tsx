      ...
      <div className="mx-auto flex w-full max-w-7xl min-h-[calc(100vh-3.5rem)]">
        ...
        <aside className="w-64 border-r border-slate-200 bg-white p-5 space-y-6 hidden lg:block shrink-0 select-none">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-4 space-y-2">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">프로젝트 워크스페이스</p>
            <h3 className="font-bold text-sm text-slate-900 truncate">로그인 분기 개선</h3>
            <div className="flex items-center gap-2 mt-2">
              <span className="size-2 rounded-full bg-emerald-500 animate-ping"></span>
              <span className="text-xs font-medium text-slate-500">GitHub 레포 연동됨</span>
            </div>
          </div>

          {/* User Profile Info */}
          <div className="border-t border-slate-200 pt-4">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">접속 계정 정보</p>
            <div className="flex items-center gap-2.5 rounded-lg border border-slate-100 p-2.5 bg-slate-50/30">
              <div className="size-8 rounded-full bg-slate-900 flex items-center justify-center font-black text-xs text-white">
                MJ
              </div>
              <div className="min-w-0 flex-1">
                <p className="text-xs font-black text-slate-900 truncate">김민준 (CrossLab PO)</p>
                <p className="text-[10px] font-medium text-slate-400 truncate">ceo@crosslab.co</p>
              </div>
            </div>
          </div>
          ...
          <nav className="space-y-1.5 pt-2">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 px-2">메뉴</p>
            {[
        ...
        <main className="flex-1 min-w-0 bg-slate-50/50 p-6 lg:p-8 space-y-6">
          ...
          <div className="flex items-center gap-1.5 text-xs font-medium text-slate-400 select-none">
            ...
            <span className="text-slate-900 font-semibold">로그인 분기 개선 MVP 프로젝트 (데모)</span>
          </div>

          {/* Project Banner Card */}
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-xs relative overflow-hidden">
            <div className="absolute top-0 right-0 bg-emerald-500/10 text-emerald-700 border-l border-b border-emerald-200/50 text-[10px] font-bold px-3 py-1 rounded-bl-lg tracking-wider">
              상호 서명 완료
            </div>
            
            <p className="text-xs font-bold text-orange-600 uppercase tracking-wide">CrossLab · 발주사 전용 뷰</p>
            <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-slate-950">로그인 분기 개선 MVP 프로젝트</h1>
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
                <div className="flex items-center gap-2 mb-6 border-b border-slate-100 pb-3">
                  ...
                  <h2 className="text-sm font-bold text-slate-950">프로젝트 개요 및 마일스톤 예산</h2>
                </div>
              ...
              <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
                <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs space-y-6">
                  <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                    ...
                    <h2 className="text-sm font-bold text-slate-950">합의된 업무명세서 (SOW)</h2>
                  </div>
                ...
                <aside className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs h-fit space-y-6">
                  <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                    ...
                    <h2 className="text-sm font-bold text-slate-950">상호 서명 검증</h2>
                  </div>
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h2 className="text-sm font-bold text-slate-950">연동된 GitHub 코드 저장소</h2>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 border-b border-slate-100 pb-4">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-[10px] font-extrabold uppercase tracking-wide bg-slate-100 border border-slate-200 px-2 py-0.5 rounded text-slate-600">마일스톤 1</span>
                      <h3 className="font-extrabold text-sm text-slate-900">M1 · 웹페이지 로그인 분기 개선 (Login Branching Fix)</h3>
                ...
                <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <p className="text-xs font-black text-slate-800">에이전트 검수 내역</p>
                      <p className="text-[11px] font-semibold text-slate-400">검수 스크립트: Playwright E2E</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    <p className="text-xs font-black text-slate-800">에이전트 검수 빌드 로그</p>
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs space-y-6">
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 border-b border-slate-100 pb-4">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-[10px] font-extrabold uppercase tracking-wide bg-slate-100 border border-slate-200 px-2 py-0.5 rounded text-slate-600">마일스톤 2</span>
                      <h3 className="font-extrabold text-sm text-slate-900">M2 · QA 및 최종 검수 (Final QA & Inspection)</h3>
                      ...
                      {m2Status === "approved" && (
                        <span className="inline-flex shrink-0 rounded-full px-2.5 py-0.5 text-[10px] font-bold bg-green-50 text-green-700 border border-green-200">
                          최종 승인 완료
                        </span>
                      )}
                      {m2Status === "rejected" && (
                        <span className="inline-flex shrink-0 rounded-full px-2.5 py-0.5 text-[10px] font-bold bg-red-50 text-red-700 border border-red-200">
                          수정 요청됨
                        </span>
                      )}
                    </div>
                ...
                <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <p className="text-xs font-black text-slate-800">에이전트 검수 내역</p>
                      <p className="text-[11px] font-semibold text-slate-400">검수 방법: 자동 스크립트 + 반응형 시각 검사</p>
                    </div>
                      ...
                      <div className="rounded-lg border border-slate-200 p-5 bg-orange-50/20 space-y-4">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="inline-flex h-9 items-center justify-center rounded-lg bg-slate-950 px-4 text-xs font-black text-white hover:bg-slate-800 transition-colors shadow-xs hover:cursor-pointer"
                          >
                            <Check className="size-3.5 mr-1" /> 최종 검수 승인
                          </button>
                          <button
                            onClick={() => setShowRevisionModal(true)}
                            className="inline-flex h-9 items-center justify-center rounded-lg border border-red-200 bg-white px-4 text-xs font-black text-red-600 hover:bg-red-50 hover:border-red-300 transition-colors shadow-xs hover:cursor-pointer"
                          >
                            <XCircle className="size-3.5 mr-1" /> 수정 요청 (반려)
                          </button>
                          <a href="#" className="inline-flex h-9 items-center justify-center rounded-lg border border-slate-200 bg-white px-4 text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-xs">
                    ...
                    {m2Status === "approved" && (
                      <div className="rounded-lg border border-green-200 p-4 bg-green-50/20 text-xs text-green-800 flex gap-2">
                        ...
                        <div>
                          <p className="font-bold">최종 검수를 승인하셨습니다.</p>
          ...
          {activeTab === "payments" && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
                <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                  <FileText className="size-4 text-slate-700" />
                  <h2 className="text-sm font-bold text-slate-950">마일스톤 정산 청구서 (Invoices)</h2>
                </div>
                <div className="space-y-3">
                  <article className="rounded-lg border border-slate-200 p-5 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                      <span className="text-[10px] font-extrabold text-slate-400 uppercase bg-slate-100 border border-slate-200 px-2 py-0.5 rounded">마일스톤 1</span>
                      <h3 className="font-extrabold text-sm text-slate-900 mt-2">M1 · 웹페이지 로그인 분기 개선 (Login Branching Fix)</h3>
                      <p className="mt-1.5 text-xs text-slate-600 font-bold">8,000 USD</p>
                      <p className="mt-1 text-[10px] text-slate-400">Invoice: INV-2026-001 · 외부 정산 참조 ID: TX-987654321</p>
                    </div>
                    ...
                    {m1InvoiceStatus === "pending" ? (
                      <div className="flex gap-2 shrink-0 self-start sm:self-center">
                        <button 
                          ...
                          className="inline-flex h-8 items-center justify-center rounded-md bg-slate-950 px-3 text-xs font-bold text-white hover:bg-slate-800 transition-colors hover:cursor-pointer shadow-xs"
                        >
                          대금 지급 승인
                        </button>
                      </div>
                    ) : (
                      <span className="inline-flex shrink-0 rounded-full px-3 py-1 text-xs font-bold bg-green-50 text-green-700 border border-green-200 self-start sm:self-center shadow-xs">
                        대금 지급 승인 완료
                      </span>
                    )}
                  </article>
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
                <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                  ...
                  <h2 className="text-sm font-bold text-slate-950">마일스톤 통합 증빙 (Evidence Bundles)</h2>
                </div>
                  ...
                  <article className="rounded-lg border border-slate-200 p-5 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="space-y-1.5 min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">M1 통합 증빙 파일 v1.0</h3>
            ...
            <form onSubmit={handleRequestRevision} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-lg border border-slate-200 p-3 text-xs focus:outline-none focus:ring-1 focus:ring-slate-900 font-semibold"
                />
              </div>
              ...
              <div className="flex justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="inline-flex h-8 items-center justify-center rounded-md bg-slate-950 px-4 text-xs font-bold text-white hover:bg-slate-800 transition-colors shadow-xs"
                >
